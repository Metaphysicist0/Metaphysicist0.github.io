...
5. **Tianliang Yao**, Zhiqiang Pei, Yong Li, Yixuan Yuan, and Peng Qi, "*Real-Time Guidewire Tip Tracking Using a Siamese Network for Image-Guided Endovascular Procedures*", IEEE Robotics and Automation Letters (RA-L). (JCR Q1, IF: 4.6, revise and resubmit)
6. Di Ding<sup>\*</sup>, **Tianliang Yao<sup>\*</sup>**, Genyi Feng, Xueqing Gao, Rong Luo, Xusen Sun, "*Empowering Biomedical Research with Foundation Models in Computational Microscopy: A Systematic Review*", Advanced Intelligent Systems (AISY). (JCR Q1, IF: 6.8, revise and resubmit)
