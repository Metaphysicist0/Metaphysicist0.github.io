...
6. Hui Zhang, **Tianliang Yao**, Cheng Ding, "*Wearable Devices for Blood Glucose Measurement: A Review*", Artificial Intelligence Review. (JCR Q1, IF: 10.7, minor revision)
7. Mengjie Shi, **Tianliang Yao**, Tom Vercauteren, Wenfeng Xia, "*Data-driven Needle Tip Tracking with A Photoacoustic Beacon for Ultrasound-Guided Minimally Invasive Procedures*", IEEE Open Journal of Ultrasonics, Ferroelectrics, and Frequency Control (Special Section: 2024 UFFC Joint Symposium). (revise and resubmit)
8. Haoyu Wang, **Tianliang Yao**, Bin Chen, Chenyu Zhou, Hangling Sun, and Anji Li, "*Adaptive Electromagnetic Signal Analysis via Non-Euclidean Manifold Learning for Atmospheric Precipitation Understanding*", IEEE Signal Processing Letters. (JCR Q1, IF: 3.2, revise and resubmit)
9. Haoyu Wang, **Tianliang Yao**, Bin Chen, Yujie Zeng, Chenyu Zhou, Anji Li, "*Operational Risk Mitigation in Complex Systems: Enhancing Safety and Reliability of Power Generation Systems on Intelligent Control Strategies Using Adversarial Imitation Learning*", IEEE Transactions on Parallel and Distributed Systems (T-PDS). (JCR Q1, IF: 5.6, major revision)
10. Haoyu Wang, Bin Chen, **Tianliang Yao**, Yujie Zeng, Chenyu Zhou, Anji Li, "*Distributed Adversarial Learning for Parallel Computational Strategies in Intelligent Power System Control Optimization*", ISA Transaction. (JCR Q1, IF: 6.3, major revision)
11. Tianliang Yao, Yueqi Xu, Haoyu Wang, Xihe Qiu, Kaspar Althoefer, and Peng Qi, "*LLM-guided MARL for Endovascular Intervention*" (double blind review), IEEE Transactions on X. (under review)
